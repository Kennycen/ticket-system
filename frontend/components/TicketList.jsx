  ...
  useEffect(() => {
    const fetchTickets = async () => {
      try {
        ...
        setTickets(response.data); // ✅ FIXED: set only the actual ticket array
      } catch (error) {
            ...
            <div className="flex justify-between items-start">
              <div>
                <h3 className="font-medium">
                  ...
                  >
                    Ticket #{ticket._id?.slice(-5) || ticket.id} - {ticket.name}
                  </Link>
                </h3>
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <button
                  onClick={() =>
                    router.push(`/admin/tickets/${ticket._id || ticket.id}`)
                  }
